...
// Create a wrapper component with correct typing
const CustomProgress = ({ value, color }: { value: number, color: string }) => {
  return (
    <div className="w-full">
      <Progress value={value} className="h-3" color={color as any} />
    </div>
  );
};
